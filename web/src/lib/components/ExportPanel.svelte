...
>
	<span class="text-[11px] font-semibold text-muted max-[1050px]:col-span-full">export</span>

	<div class="mt-2 flex flex-col gap-1.5 border-b border-subtle pb-2.5">
		<span class="mb-0.5 text-[11px] text-muted">Current page</span>
	...
	<div class="mt-2 flex flex-col gap-1.5 border-b border-subtle pb-2.5">
		<span class="mb-0.5 text-[11px] text-muted">Whole document</span>
	...
	<div class="mt-2 flex flex-col gap-1.5">
		<span class="mb-0.5 text-[11px] text-muted">Structure</span>
	...
	{#if exporting}
		<button class="mt-2 cursor-pointer bg-transparent py-2 font-mono text-[11px] text-muted underline underline-offset-3" type="button" onclick={onCancel}>
			cancel export
		</button>
	{/if}
</aside>
